...
const services = [
  {
    ...
    description: "Immersive landing pages and portfolios featuring premium motion design, custom typographic grids, and verified Core Web Vitals performance.",
  },
  {
    title: "SaaS Platforms",
    description: "Highly responsive application dashboards and portals optimized for seamless user onboarding, data density, and sub-second updates.",
  },
  {
    title: "Bespoke Web Apps",
    description: "Custom digital tools engineered on server-first routing frameworks with secure database schemas and modular cloud services.",
  },
];
    ...
    <Section className="border-t border-border/20 relative">
      <Container>
        <Stack gap={16}>
          ...
          <div className="flex flex-col border-t border-border/20 mt-8">
