...
const steps = [
  {
    ...
    description: "We analyze your audience context, audit competitor gaps, and define a distinct strategic roadmap for your digital presence.",
  },
  {
    phase: "PHASE 02",
    title: "Bespoke Visual Design",
    description: "We construct custom layouts, typographic hierarchy, and visual motion paths. Every design element is tailored to match your brand personality.",
  },
  {
    phase: "PHASE 03",
    title: "Production Engineering",
    description: "Clean, performant compilation using React 19, Next.js 15, strict type checking, and modular layout primitives optimized for conversion.",
  },
  {
    phase: "PHASE 04",
    title: "Deployment & Optimization",
    description: "Global delivery on fast edge servers, database provisioning via Supabase, and dynamic asset management using Cloudinary.",
  },
];
    ...
    <Section id="process" className="border-t border-border/20 bg-background/20 relative">
      <Container>
        <Stack gap={16}>
          ...
          <div className="relative pl-8 md:pl-16 border-l border-border/50 flex flex-col gap-20 md:gap-28 max-w-4xl mt-8">
